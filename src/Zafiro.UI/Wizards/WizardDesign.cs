...
{
    public IEnhancedCommand Back { get; } = EnhancedCommand.Create(ReactiveCommand.Create(() => { }));
    public IEnhancedCommand Next { get; }= EnhancedCommand.Create(ReactiveCommand.Create(() => { }));
